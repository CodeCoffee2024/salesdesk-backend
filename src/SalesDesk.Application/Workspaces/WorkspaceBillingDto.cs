...
public sealed class WorkspaceBillingDto
{
    ...
    /// <summary>True while this workspace is on its one-time 7-day Full Access trial — see Workspace.IsFreeTrial.</summary>
    public bool IsFreeTrial { get; init; }

    /// <summary>TASK-038: this tier's monthly document cap, or null when unlimited (Pro/Full Access).</summary>
