...
namespace SalesDesk.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260910163507_AddDocumentPaymentTracking")]
    partial class AddDocumentPaymentTracking
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SalesDesk.Domain.Billing.GCashPaymentSubmission", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<string>("GCashReferenceNumber")
                        ...
                        .HasColumnName("g_cash_reference_number");

                    b.Property<bool>("IsApproved")
                        .HasColumnType("boolean")
                        .HasColumnName("is_approved");

                    b.Property<string>("ScreenshotDataUrl")
                        .HasColumnType("text")
                        .HasColumnName("screenshot_data_url");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_g_cash_payment_submissions");

                    b.HasIndex("ApprovalTokenHash")
                        .IsUnique()
                        .HasDatabaseName("ix_g_cash_payment_submissions_approval_token_hash");

                    b.HasIndex("WorkspaceId")
                        .HasDatabaseName("ix_g_cash_payment_submissions_workspace_id");

                    b.ToTable("g_cash_payment_submissions", (string)null);
                });

            modelBuilder.Entity("SalesDesk.Domain.Billing.SubscriptionUpgradeRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_subscription_upgrade_requests");

                    b.HasIndex("ApprovalTokenHash")
                        .IsUnique()
                        .HasDatabaseName("ix_subscription_upgrade_requests_approval_token_hash");

                    b.HasIndex("WorkspaceId")
                        .HasDatabaseName("ix_subscription_upgrade_requests_workspace_id");
            ...
            modelBuilder.Entity("SalesDesk.Domain.Documents.Document", b =>
                {
                    ...
                    b.HasIndex("StripeCheckoutSessionId")
                        .IsUnique()
                        .HasDatabaseName("ix_documents_stripe_checkout_session_id");
            ...
            modelBuilder.Entity("SalesDesk.Domain.Documents.DocumentActivity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_document_activities");

                    b.HasIndex("DocumentId", "OccurredAtUtc")
                        .HasDatabaseName("ix_document_activities_document_id_occurred_at_utc");
            ...
            modelBuilder.Entity("SalesDesk.Domain.Promotions.PromoCounter", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_promo_counters");

                    b.HasIndex("Key")
                        .IsUnique()
                        .HasDatabaseName("ix_promo_counters_key");

                    b.ToTable("promo_counters", (string)null);
            ...
            modelBuilder.Entity("SalesDesk.Domain.Workspaces.Workspace", b =>
                {
                    ...
                    b.Property<bool>("IsEarlyBirdPromo")
                        .HasColumnType("boolean")
                        .HasColumnName("is_early_bird_promo");
            ...
            modelBuilder.Entity("SalesDesk.Domain.Documents.DocumentActivity", b =>
                {
                    b.HasOne("SalesDesk.Domain.Documents.Document", "Document")
                        ...
                        .IsRequired()
                        .HasConstraintName("fk_document_activities_documents_document_id");
